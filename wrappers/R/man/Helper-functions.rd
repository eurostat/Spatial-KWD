...
\description{
The Spatial KWD package has a set of helper functions to easy the use of the library, without explicitly dealing with the internal data structures of the library specified later.
}
\usage{
# Exact methods
